...
<div class="row justify-content-center">
    <div class="col-lg-7 col-xl-6">
        <div class="d-flex align-items-center mb-4">
            ...
            <div>
                <h4 class="fw-bold mb-1" style="color: var(--uk-dark);">Edit Modal Usaha</h4>
                <p class="text-muted small mb-0">Perbarui rincian catatan modal kerja usaha</p>
            </div>
        </div>

        <div class="card uk-card border-0">
            <div class="card-body p-4">
                <form method="POST" action="{{ route('owner.capital.update', $capital) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group input-group-lg">
                            ...
                            <input
                                ...
                                id="amount"
                                name="amount"
                                value="{{ old('amount', $capital->amount) }}"
                                placeholder="0"
                                min="0"
                                required
                                autofocus
                    ...
                    <div class="mb-3">
                        ...
                        <input
                            ...
                            id="entry_date"
                            name="entry_date"
                            value="{{ old('entry_date', $capital->entry_date->format('Y-m-d')) }}"
                            required
                        >
                        @error('entry_date')
                            <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="mb-3">
                        ...
                        <input
                            ...
                            id="source"
                            name="source"
                            value="{{ old('source', $capital->source) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea
                            ...
                            name="description"
                            rows="3"
                            placeholder="Catatan tambahan mengenai modal ini (opsional)"
                        >{{ old('description', $capital->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
