...
@section('title', 'Rincian Penjualan #TRX-' . str_pad($sale->id, 5, '0', STR_PAD_LEFT))

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
    <div>
        <h4 class="fw-bold mb-1">Rincian Nota Penjualan</h4>
        <p class="text-muted mb-0">Rincian detail transaksi penjualan produk dan pemotongan stok</p>
    </div>
        ...
        <div class="card border shadow-sm print-area">
            <div class="card-body p-4 p-md-5">
                ...
                <div class="text-center border-top pt-4 text-muted small">
                    <p class="mb-1 fw-semibold">Terima Kasih Atas Kunjungan Anda!</p>
                    <p class="mb-0 text-secondary" style="font-size: 0.75rem;">Sistem Pembukuan & Kasir Digital: Untung Klik</p>
                </div>
            </div>
        </div>
    </div>
