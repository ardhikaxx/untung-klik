...
@section('title', 'Catat Penjualan Harian')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
    <div>
        <h4 class="fw-bold mb-1">Catat Penjualan Harian</h4>
        <p class="text-muted mb-0">Pilih produk yang terjual, stok otomatis berkurang dan pendapatan otomatis masuk ke Buku Kas</p>
    </div>
...
@if($products->isEmpty())
    <div class="card border shadow-sm">
        <div class="card-body text-center py-5">
            ...
            <h6 class="fw-bold text-dark">Belum Ada Katalog Produk</h6>
            <p class="text-muted small mb-3">Anda perlu menambahkan produk terlebih dahulu sebelum dapat mencatat penjualan dengan pemotongan stok.</p>
...
<form method="POST" action="{{ route('owner.sales.store') }}" id="saleForm">
    ...
    <div class="row g-4">
        <!-- Kolom Kiri: Pilihan Produk yang Terjual -->
        <div class="col-lg-8">
            <div class="card border shadow-sm mb-4">
                <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                    <h6 class="fw-bold mb-0">
                        <i class="fas fa-shopping-basket text-success me-2"></i>Daftar Item Terjual
                    </h6>
                    <button type="button" class="btn btn-sm btn-outline-success" onclick="addItemRow()">
                        <i class="fas fa-plus me-1"></i>Tambah Baris Produk
                    </button>
                </div>
        ...
        <!-- Kolom Kanan: Rincian Pembayaran & Tanggal -->
        <div class="col-lg-4">
            <div class="card border shadow-sm mb-4">
                <div class="card-header bg-white py-3">
                    <h6 class="fw-bold mb-0">
                        <i class="fas fa-receipt text-primary me-2"></i>Ringkasan Transaksi
                    </h6>
                </div>
                <div class="card-body p-4">
                    <div class="p-3 bg-light rounded-3 mb-4 text-center">
                        <span class="text-muted small fw-semibold text-uppercase">Total Pembayaran</span>
                    ...
                    <div class="mb-3">
                        <label for="transaction_date" class="form-label fw-semibold small">Tanggal Penjualan <span class="text-danger">*</span></label>
                    ...
                    <div class="mb-4">
                        <label for="description" class="form-label fw-semibold small">Keterangan Tambahan</label>
                        <textarea class="form-control" id="description" name="description" rows="2"
                                  placeholder="Contoh: Pesanan Ibu Ani, Meja 3, dll (opsional)">{{ old('description') }}</textarea>
                    </div>

                    <button type="submit" class="btn btn-success w-100 py-2 fw-bold fs-6" id="submitBtn">
                        <i class="fas fa-check-circle me-1"></i>Simpan Penjualan
                    </button>
                    <a href="{{ route('owner.sales.index') }}" class="btn btn-outline-secondary w-100 mt-2">Batal</a>
                </div>
            </div>
            ...
            <div class="card border shadow-sm">
                <div class="card-body p-3">
                    <div class="d-flex gap-2 text-muted small">
                        ...
                        <div>
                            <strong>Otomatisasi Kas:</strong> Nilai penjualan langsung dicatat ke kas masuk, stok barang berkurang, dan mutasi tercatat secara atomik.
                        </div>
                    </div>
                </div>
            </div>
