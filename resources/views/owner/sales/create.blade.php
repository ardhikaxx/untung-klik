...
<div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
    <div>
        <h4 class="fw-bold mb-1">Kasir & Catat Penjualan Harian</h4>
        <p class="text-muted mb-0">Pilih produk secara cepat atau gunakan tabel transaksi. Stok otomatis terpotong dan tercatat di Buku Kas.</p>
    </div>
    <div class="d-flex gap-2">
        <a href="{{ route('owner.sales.index') }}" class="btn btn-outline-secondary">
            <i class="fas fa-history me-1"></i>Riwayat Penjualan
        </a>
        <a href="{{ route('owner.products.create') }}" class="btn btn-outline-success">
...
@if($products->isEmpty())
    <div class="card border shadow-sm">
        <div class="card-body text-center py-5">
            ...
            <p class="text-muted small mb-3">Anda perlu menambahkan produk terlebih dahulu ke sistem sebelum mencatat penjualan kasir.</p>
            ...
            <div class="card border shadow-sm">
                ...
                <div class="card-body p-0">
                    ...
                    <div id="emptyCartNotice" class="text-center py-5 text-muted">
                        ...
                        <p class="mb-1 fw-semibold text-dark">Keranjang Penjualan Masih Kosong</p>
                        <small>Klik produk pada kotak di atas atau klik tombol "Tambah Baris Dropdown" untuk memilih.</small>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card border shadow-sm sticky-top" style="top: 20px; z-index: 10;">
                ...
                <div class="card-body p-3 p-sm-4">
                    ...
                    <!-- Info Pelanggan -->
                    <div class="mb-3">
                        <label for="customer_name" class="form-label small fw-semibold">Nama Pelanggan (Opsional)</label>
                        <div class="input-group input-group-sm">
                    ...
                    <button type="submit" class="btn btn-success w-100 py-2 fw-bold fs-6 shadow-sm" id="submitBtn">
                        <i class="fas fa-check-circle me-1"></i>Simpan & Cetak Struk
                    </button>
                    <a href="{{ route('owner.sales.index') }}" class="btn btn-outline-secondary w-100 mt-2 btn-sm">Batal</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function addItemRow() {
        // Add first available product not yet in cart, or any product
    ...
    function onManualQtyInput(index, inputElem) {
        ...
        cart[index].qty = val;
        renderCart(false); // don't redraw input to avoid losing focus
    }
