...
<div class="uk-page-header">
    <div>
        <h2 class="uk-page-title">Kasir & Penjualan Toko</h2>
        <p class="uk-page-subtitle">Pilih barang belanjaan pembeli dengan cepat, stok terpotong otomatis dan bukti nota siap dicetak.</p>
    </div>
    <div class="d-flex align-items-center gap-2 flex-wrap">
        <a href="{{ route('karyawan.sales.index') }}" class="btn btn-sm btn-uk-outline rounded-pill px-3">
            <i class="fas fa-history me-1.5"></i>Riwayat Kasir Saya
        </a>
    </div>
</div>
...
@if($products->isEmpty())
    <div class="uk-card text-center p-4 p-md-5">
        ...
        <h5 class="fw-bold text-dark mb-1">Belum Ada Produk Tersedia</h5>
        <p class="text-muted small mb-0">Hubungi pemilik usaha (Owner) untuk menambahkan daftar produk ke sistem katalog toko.</p>
    </div>
@else
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="uk-card p-0 overflow-hidden uk-sticky-card">
                <div class="p-3 px-4 border-bottom bg-white d-flex align-items-center justify-content-between">
                    ...
                    <span class="badge bg-light text-dark border">Kasir Shift</span>
                </div>
