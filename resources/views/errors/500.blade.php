...
<head>
    ...
    <title>Kesalahan Server - Untung Klik</title>
    ...
    <style>
        ...
        .error-icon { width: 80px; height: 80px; background: #fffbeb; border-radius: 50%; display: inline-flex; align-items: center; justify-content: center; margin-bottom: 24px; }
        .error-icon i { font-size: 36px; color: #f59e0b; }
...
<body>
    <div class="error-card">
        ...
        <p>Terjadi kesalahan pada server. Silakan coba lagi beberapa saat.</p>
