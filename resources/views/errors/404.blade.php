...
<head>
    ...
    <title>Halaman Tidak Ditemukan - Untung Klik</title>
    ...
    <style>
        ...
        .error-icon { width: 80px; height: 80px; background: #eff6ff; border-radius: 50%; display: inline-flex; align-items: center; justify-content: center; margin-bottom: 24px; }
        .error-icon i { font-size: 36px; color: #3b82f6; }
